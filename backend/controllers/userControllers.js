...
module.exports = {
  ...
  postPost: function (req, res) {
    ...
    try {
      ...
      userHelpers.doAddPost({ ...req.body, postPicture }).then((response) => {
        if (response) {
  ...
  postProfile: function (req, res) {
    ...
    try {
      ...
      userHelpers.doAddProfile({ ...req.body, profilePicture }).then((response) => {
        if (response) {
  ...
  reportpost: function (req, res) {
    ...
    try {
      ...
      userHelpers.doreport(req.body.postid, req.body.userid,req.body.text).then((response) => {
        if (response) {
          // console.log("##############", response.username);
          console.log("##############", response);
          // let username = response.username;
