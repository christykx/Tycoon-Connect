                            ...
                            <>
                                < div >
                                    ...
                                    <Stack direction="row" justifyContent="space-between">
                                        ...
                                        <div>
                                            <Stack direction="row" justifyContent="space-between">
                                                <img className='conversationImg' src={`${config.ServerURL}/uploads/${currentChat?.ProfileData.profilePicture}`} alt='' />
                                                <h5 style={{ fontVariant: 'small-caps', fontFamily: ' Garamond, serif ', fontWeight: 'bold' }}>{currentChat?.username}</h5>
                                            </Stack>
                                        </div>

                                        <IconButton style={{ marginTop: '-6px', marginRight: '-15px' }}>
                                            <VideoCall style={{ color: 'green', fontSize: '35px', marginLeft: '5px', marginTop: '-4px' }} />
                                            {/* <VideocamIcon/> */}
                                        </IconButton>
