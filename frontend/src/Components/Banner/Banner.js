import { Box, Button, Checkbox, Divider, ListItemIcon, ListItemText, Menu, MenuItem, Modal, Stack, TextareaAutosize, Tooltip } from '@mui/material'
...
function Banner({ socket }) {
    ...
    const handlereport = (postid) => {
        ...
        makeRequest.post('/users/reportpost', { postid, userid: id, text: newreport }).then((response) => {
                                ...
                                <CardHeader
                                    avatar={
                                        <StyledBadge
                                            ...
                                            variant="dot"
                                        >
                                            <Avatar sx={{ bgcolor: "purple" }} alt="Christy" src={`${config.ServerURL}/uploads/${profile}`} />
                                        </StyledBadge>
